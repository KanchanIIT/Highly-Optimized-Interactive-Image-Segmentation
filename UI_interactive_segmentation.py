...
class Example(Frame):
    ...
    def callback_left(self, event):
        ...
        print (self.usrId, self.imIdx, self.filename, self.cnt, 1, event.x, event.y)
        #(82197337, 0, '/Users/kanchan.sarkar/Documents/testing/11.jpg', 0, 1, <Tkinter.Event instance at 0x155e87bd8>)
